package com.myspring.gachon.friendFind.vo;

import org.apache.ibatis.type.Alias;

@Alias(value = "FriendInfoVO")
public class FriendInfoVO {
	...
	private String isFnd;
	private Integer fndMemberId;
	...
	public String getIsFnd() {
		return isFnd;
	}
	public void setIsFnd(String isFnd) {
		this.isFnd = isFnd;
	}
	public Integer getFndMemberId() {
		return fndMemberId;
	}
	public void setFndMemberId(Integer fndMemberId) {
		this.fndMemberId = fndMemberId;
	}
